  ...
  <b-container class="section-3-page">
    <b-row>
      <b-col>
        ...
        <ul>
          ...
          <li>If you get it <strong>wrong</strong>, you lose the <strong>half</strong> amount of points, and your
          ...
          <li>
            <ul>
              ...
              <li>If they also get it wrong, they lose <strong>no points</strong>.</li>
            </ul>
          </li>
        </ul>
    ...
    <b-row class="mt-4 pt-2 links-row">
      ...
      <b-col class="text-right">
        <router-link to="/section-3-selection">Go to Questions</router-link>
      </b-col>
    </b-row>
  </b-container>
</template>
